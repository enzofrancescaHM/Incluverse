AFRAME.registerComponent('ministart', {
    ...
    init: function()
    {
      ...
      //let nametagInput = document.getElementById('username-overlay');
      //nametagInput.value = 'user-' + Math.round(Math.random() * 10000) ;
      ...
      let fadeIn = function()
      {
        ...
        //var player = document.getElementById('cameraRig');
        //var myNametag = player.querySelector('.nametag');
        //myNametag.setAttribute('value', nametagInput.value);
      }
